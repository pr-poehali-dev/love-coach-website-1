            ...
            <CardContent className="p-4 sm:p-6 md:p-8 space-y-6 md:space-y-8">
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    1.2. Исполнитель: Индивидуальный предприниматель [ФИО], ОГРНИП [номер], ИНН [номер], 
                    зарегистрированный в г. Москва в соответствии с законодательством Российской Федерации.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    3.2. Исполнитель вправе оказывать услуги на индивидуальных условиях 
                    («гибкий / расширенный формат»). Стоимость таких услуг согласуется сторонами 
                    до начала работы и подтверждается Заказчиком самостоятельной оплатой согласованной 
                    суммы через форму на Сайте.
                  </p>
                  <p>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    Актуальная редакция оферты опубликована на https://workstab.com/offer.
                  </p>
                </div>
              </section>
