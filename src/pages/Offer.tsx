          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  <p>
                    ...
                    (далее — «Исполнитель») заключить договор на оказание немедицинских консультационных услуг 
                    с любым физическим лицом (далее — «Заказчик»).
                  </p>
                  <p>
                    1.2. Исполнитель: ИП Иванов Иван Иванович, ИНН: 123456789012, 
                    зарегистрированный как самозанятый согласно Федеральному закону №422-ФЗ от 27.11.2018 
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  <p>
                    2.1. Исполнитель обязуется предоставить Заказчику немедицинские консультационные услуги 
                  ...
                  <p>
                    ...
                    психологическими или психиатрическими. Исполнитель не ставит диагнозы и не занимается лечением.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    3.2. Оплата производится предварительно через платёжную систему ЮKassa с использованием банковских карт.
                    В соответствии с Федеральным законом №54-ФЗ Заказчику направляется электронный чек.
                  </p>
                  <p>
                    3.3. Услуга считается оказанной с момента проведения консультации или предоставления доступа к чату.
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    8.3. Контактная информация: email: hello@workstab.com, телефон: +7 (999) 123-45-67
                  </p>
                </div>
              </section>
