          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardContent className="p-4 sm:p-6 md:p-8 space-y-6 md:space-y-8">
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    ...
                    состав персональных данных и совершаемые с ними действия.
                  </p>
                  <p>
                    1.4. Используя Сайт, пользователь подтверждает,
                    что ознакомился с настоящей Политикой и даёт согласие на обработку
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  <p>
                    4.1. Обработка персональных данных ИП осуществляется на основании
                    подпунктов 1, 5, 6, 7 части 1 статьи 6 Федерального закона № 152-ФЗ,
                    а именно:
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>согласия субъекта персональных данных;</li>
                    <li>необходимости исполнения договора на оказание услуг;</li>
                    <li>необходимости соблюдения правовых обязанностей ИП;</li>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>3 лет после окончания договорных отношений (для целей ведения отчётности) или до получения от субъекта персональных данных отзыва согласия на обработку, если дальнейшее хранение не требуется по закону</li>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <p>
                    6.2. Платёжная система ЮKassa (для обработки платежей),
                    хостинг-провайдер (для технического обеспечения работы сайта),
                    государственные органы (по законному запросу). Передача
                    осуществляется только в объёме, необходимом для выполнения
                    перечисленными лицами своих функций.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>меры защиты соответствуют ст. 19 ФЗ-152 и Постановлению Правительства РФ № 1119</li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>получать ответ на запрос в течение 30 календарных дней с момента его поступления</li>
                  </ul>
                  <p>
              ...
              <section>
                ...
                <div className="text-gray-700 space-y-4">
                  <p>
                    9.1. Сайт использует файлы cookie, в том числе для аналитики
                    (Яндекс Метрика, Google Analytics) и улучшения пользовательского опыта.
                  </p>
                  <p>
              ...
              <div className="text-center pt-8 border-t border-gray-200">
                <p className="text-gray-600 mb-4">
                  Актуальная редакция Политики опубликована по адресу - workstab.com/privacy
                </p>
                <p className="text-gray-600">
